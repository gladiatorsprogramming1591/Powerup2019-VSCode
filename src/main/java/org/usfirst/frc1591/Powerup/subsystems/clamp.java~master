...
public class clamp extends Subsystem {
    ...
    private final DigitalInput rightPincherClosed = RobotMap.clamprightPincherClosed;
    private final DigitalInput leftPincherClosed = RobotMap.clampleftPincherClosed;
    private final DigitalInput blockIn = RobotMap.clampblockIn;
